...
import * as logger from '@bgio/core/logger';
import { Auth } from '@bgio/core/auth';
import { SocketIO } from './transport/socketio';
import type { KoaServer, ServerConfig, ServerOpts, ServerApp, ServerAppCtx } from './types';
...
export function Server({
  ...
  const router = new Router<any, ServerAppCtx>();
