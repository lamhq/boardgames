...
import type {
  ...
  TransportData,
} from '@boardgameio/core/master/master';
import { getFilterPlayerView } from '@boardgameio/core/master';
import type { Game } from '@boardgameio/core/types';
import type { ServerApp } from '../types';
import type { GenericPubSub } from './pubsub/generic-pub-sub';
import type { IntermediateTransportData } from '@boardgameio/core/master/master';
...
export class SocketIO {
  ...
  init(
    app: ServerApp & { _io?: IOTypes.Server },
    games: Game[],
