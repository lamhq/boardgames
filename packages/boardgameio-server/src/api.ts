...
import { createMatch, getFirstAvailablePlayerID, getNumPlayers } from '@boardgameio/core/util';
import type { Auth } from '@boardgameio/core/auth';
import type { Server, LobbyAPI, Game, StorageAPI } from '@boardgameio/core/types';
import type { ServerApp, ServerAppCtx } from './types';
...
export const configureRouter = ({
  ...
  router: Router<any, ServerAppCtx>;
  auth: Auth;
  games: Game[];
  uuid?: () => string;
  db: StorageAPI.Sync | StorageAPI.Async;
