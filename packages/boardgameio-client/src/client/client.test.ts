...
import { INVALID_MOVE, CreateGameReducer, InitializeGame, ProcessGameConfig } from '@boardgameio/core';
...
import {
  ...
  gameEvent,
  patch,
} from '@boardgameio/core/action-creators';
import * as Actions from '@boardgameio/core/action-types';

import { error } from '@boardgameio/core/logger';
import type { Game, LogEntry, State, SyncInfo } from '@boardgameio/core/types';
